...
public class ComplaintServiceImpl implements ComplaintService {
    ...
    public ComplaintDto saveComplaint(ComplaintDto complaintDto) {
        LOGGER.info("enter saveComplaint method");
        ...
        LOGGER.info("exit from saveComplaint method");
        return savedComplaintDto;

    }

    private void validateInputs(ComplaintDto complaintDto) {
        LOGGER.info("enter validateInputs method");
        ...
        LOGGER.info("exit from validateInputs method");
    }

    @Override
    public APIResponseDto getComplaintById(UUID complaintId) {

        LOGGER.info("enter getComplaintById method");
        ...
        LOGGER.info("exit from getComplaintById method");
